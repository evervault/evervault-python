...
class TestOutboundRelayConfig(unittest.TestCase):
    ...
    def test_clear_cache(self, mock_request):
        ...
        OutboundRelayConfig.clear_cache()
        assert OutboundRelayConfig.get_decryption_domains() == None
    ...
    def __mock_relay_outbound_config_poll_interval_changed(self, mock_request, initial_poll_interval = 5, new_poll_interval = 10):
            mock_request.get(
                "https://api.evervault.com/v2/relay-outbound",
                [
                    {
